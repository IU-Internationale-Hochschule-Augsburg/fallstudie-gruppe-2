...
Arduino Getting Started Guide: [Arduino Getting Started](https://docs.arduino.cc/)<br>
GitHub Getting Started Guide: [GitHub Documentation](https://docs.github.com/de)<br>
Library Documentation for Arduino: [Arduino Library](https://www.arduino.cc/reference/en/libraries/)<br>
